...
public class TeamView extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readTeamStats read = new readTeamStats();
        ...
        ArrayList<Team> teamList = read.CreateList(this);
        createStatView(this, tableMain, tableLeft, tableTop, teamList);
    ...
    public void createStatView(Activity activity, TableLayout tableMain, LinearLayout tableLeft, LinearLayout tableTop, ArrayList<Team> teamList) {
        try {

            String str;
            String[] dataArrSkater; // array for the names of the skater-data variables
            BufferedReader br = new BufferedReader(new InputStreamReader(getAssets().open("teams.csv")));
            str = br.readLine();
            ...
            for (i = 6; i < dataArrSkater.length; i++) {
            ...
            for(Team team : teamList) {
                ...
                text1.setText(Integer.toString(team.getID()));
                ...
                text6.setText(Integer.toString(team.getAllStats().getgames_played()));
                ...
                TeamAllStats stats = team.getAllStats();
