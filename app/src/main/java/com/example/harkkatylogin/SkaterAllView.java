...
public class SkaterAllView extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createStatView(SkaterAllView.this, tableMain, tableLeft, tableTop, skaterList);
    ...
    public void createStatView(Activity activity, TableLayout tableMain, LinearLayout tableLeft, LinearLayout tableTop, ArrayList<Skater> skaterList) {
        try {
            ...
            for(Skater skater : skaterList) {
                if(skater.getAllStats().getGames_played()>55) {
                    ...
                    SkaterAllStats stats = skater.getAllStats();
