...
public class Skater5on4View extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skater5on4_view);
        ...
        createStatView(Skater5on4View.this, tableMain, tableLeft, tableTop, skaterList);
    ...
    public void createStatView(Activity activity, TableLayout tableMain, LinearLayout tableLeft, LinearLayout tableTop, ArrayList<Skater> skaterList) {
        try {
            ...
            for(Skater skater : skaterList) {
                if(skater.get_5_on_4_Stats().geticetime()>30*60) {
                    ...
                    text6.setText(Integer.toString(skater.get_5_on_4_Stats().getGames_played()));
                    ...
                    Skater5on4Stats stats = skater.get_5_on_4_Stats();
