...
public class GoalieAllView extends AppCompatActivity{


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        readGoalieStats read = new readGoalieStats();
        setContentView(R.layout.activity_goalie_all_view);
        ...
        ArrayList<Goalie> goalieList = read.CreateList(this);

        createStatView(GoalieAllView.this, tableMain, tableLeft, tableTop, goalieList);
    ...
    public void createStatView(Activity activity, TableLayout tableMain, LinearLayout tableLeft, LinearLayout tableTop, ArrayList<Goalie> goalieList) {
        try {

            String str;
            String[] dataArrSkater; // array for the names of the skater-data variables
            BufferedReader br = new BufferedReader(new InputStreamReader(getAssets().open("goalie.csv")));
            str = br.readLine();
            ...
            for(Goalie goalie : goalieList) {
                ...
                name.setText(goalie.getFullName());
                ...
                text1.setText(Integer.toString(goalie.getID()));
                ...
                text6.setText(Integer.toString(goalie.getAllStats().getGames_played()));
                ...
                GoalieAllStats stats = goalie.getAllStats();
