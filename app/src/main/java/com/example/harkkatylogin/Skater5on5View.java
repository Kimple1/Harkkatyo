...
public class Skater5on5View extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_skater5on5_view);
        ...
        createStatView(Skater5on5View.this, tableMain, tableLeft, tableTop, skaterList);
    ...
    public void createStatView(Activity activity, TableLayout tableMain, LinearLayout tableLeft, LinearLayout tableTop, ArrayList<Skater> skaterList) {
        try {
            ...
            for(Skater skater : skaterList) {
                if(skater.get_5_on_5_Stats().getGames_played()>55) {
                    ...
                    text6.setText(Integer.toString(skater.get_5_on_5_Stats().getGames_played()));
                    ...
                    Skater5on5Stats stats = skater.get_5_on_5_Stats();
