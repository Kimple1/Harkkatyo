...
public class Skater4on5View extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        createStatView(Skater4on5View.this, tableMain, tableLeft, tableTop, skaterList);
    ...
    public void createStatView(Activity activity, TableLayout tableMain, LinearLayout tableLeft, LinearLayout tableTop, ArrayList<Skater> skaterList) {
        try {
            ...
            for(Skater skater : skaterList) {
                if(skater.get_4_on_5_Stats().geticetime()>10) {
                    ...
                    Skater4on5Stats stats = skater.get_4_on_5_Stats();
